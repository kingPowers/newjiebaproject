    ...
    <section class="bgl">
        <a href="/Index/message">
            <span id="info" class="top_info">
                <notempty name="count">
                    <img src="_STATIC_/2015/member/image/index/d.png" class="red_info">
                    <font color="#fff">{$count}</font>
                </notempty>
            </span>
        </a>
        <section class="con_top">
            <p>最高可借金额（元）</p>
            <h2>{$data['quota']['maxMoney']}</h2>
        </section>
        <section class="num_top">
            <section class="h_num">
                <p>最长可借天数</p>
                <font>{$data['maxPeriode']}</font>
            </section>
            <section class="h_num">
                <p>最低起借金额</p>
                <font>{$data['minLoanMoney']}</font>
            </section>
        </section>
    </section>
    <section class="p_center">
        <span>借款成功:<font class="fb">{$data['tenderSuccess']}人</font></span>
