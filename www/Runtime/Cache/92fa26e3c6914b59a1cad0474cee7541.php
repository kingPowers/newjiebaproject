...
<body style="background: #efefef;"> 
   ...
   <section class="mt40 bgf">
        <section class="con-li">
            <font>姓名</font>
            <span><?php echo ($member_info['names']); ?></span>
        </section>
        <section class="con-li">
            <font>身份证</font>
            <span><?php echo ($member_info['certiNumber']); ?></span>
        </section>
        <section class="con-li">
            <font>银行卡号</font> 
            <span><?php echo ($member_info['acc_no']); ?></span>           
        </section>
        <section class="con-li">
            <font>开户行</font>
            <span><?php echo ($member_info['bank_name']); ?></span>            
        </section>   
        <section class="con-li">
            <font>银行预留手机号</font>
            <span><?php echo ($member_info['bank_mobile']); ?></span>              
        </section>   
    </section>
</body>
</html>