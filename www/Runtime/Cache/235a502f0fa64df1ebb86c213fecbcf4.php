...
<body> 
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><a class="mui-con-li" href="/Index/service_online/id/<?php echo ($vo['user_id']); ?>">
        <?php if(($vo['isOnline']) == "1"): ?><img src="_STATIC_/2015/member/image/index/ke.png" class="ser_head">
        <?php else: ?>
            <img src="_STATIC_/2015/member/image/index/black.png" class="ser_head"><?php endif; ?>
            <h4 style="color: #000;"><?php echo ($vo['names']); ?></h4>
            <b>您好！</b>
