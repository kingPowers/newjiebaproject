...
<body>
	<div class="login_header">
		<div class="header_center">
			<a><img src="_STATIC_/manager/image/login/ico_logo.png"></a>
			<h2>商户版</h2>
		</div>
	</div>
	<div class="bg_blogin"></div>
	<div class="blogin_box pm_center box_round box_d">			
		<div class="login_sbox">				
			<div class="login_input box_round5 blue" style="margin-top: 60px;">
