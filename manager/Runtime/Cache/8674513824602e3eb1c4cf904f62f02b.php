...
<script type="text/javascript" src="_STATIC_/2015/js/wdate/WdatePicker.js"></script>
<span class='title btn btn-primary' style="margin-left: 10px;">新增</span><a href="<?php echo U('BusinessCompany/outDetail',array('company_id'=>$_REQUEST['company_id']));?>" class="btn title">支出</a>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tbody>
        <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
            <td><?php echo ($vo['deposit_number']); ?></td>
