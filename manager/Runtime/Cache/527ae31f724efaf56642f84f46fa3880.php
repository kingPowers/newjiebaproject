...
<body>
<form class="form-inline definewidth m20" action="/Capital/index" method="get">
    资金方名称：
...
<a class="btn btn-primary" href="/Capital/add" style="margin-left: 40px;">添加资金方</a>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <td><a href="/Capital/edit/id/<?php echo ($vo['id']); ?>">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/Capital/edit/id/<?php echo ($vo['id']); ?>/is_sub/1">编辑</a>
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="/Product/addCapital/cid/<?php echo ($vo['id']); ?>/is_sub/1">添加产品</a></td>
