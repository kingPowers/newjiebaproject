(function($){
    ...
    $.fn.wBox = function(options){
        ...
        var preIframe = $("#wBox_overlay"),preHide = $("#wBox");
        this.YQ = $.extend(defaults, options);
        var  wBoxHtml = '<div id="wBox"><div class="wBox_popup"><table><tbody><tr><td><div class="wBox_body">' + (_this.YQ.noTitle ? '' : '<table class="wBox_title '+ _this.YQ.titleClass +'"><tr><td class="wBox_dragTitle"><div class="wBox_itemTitle">' + _this.YQ.title + '</div></td><td width="45px" title="关闭"><div class="wBox_close"></div></td></tr></table> ') +
        ...
        this.showBox=function (){
            ...
            B = $("<div id='wBox_overlay' class='wBox_hide'></div>").hide().addClass('wBox_overlayBG').css('opacity', _this.YQ.opacity).dblclick(function(){
                _this.close();
            }).appendTo(appendNode).fadeIn(300);
            C = $(wBoxHtml).appendTo(appendNode);
            handleClick();
        }
        /*
         * 处理点击
