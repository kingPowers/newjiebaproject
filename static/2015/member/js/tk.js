...
(function($,window,document,undefined){
		   //默认参数
		    var PARAMS;
		    var DEFAULTPARAMS = { Title: "标题", Content: "",BtnL:"确定",BtnR:"取消" , FunL: new Object, FunR: new Object,Ldata:{}};
		    $.DialogByZ = {
		        //弹出提示框
		    ...
		    function loadBox(Url){		    	
		    	var url=Url;
		    	url = STATIC+"/2015/member/image/index/loading.png";
		    	...
		    	$("body").append(dislogContainer);
	    	 	// setTimeout(function(){
	    	  // 		$.DialogByZ.Close()
	    	  // 		//$.DialogByZ.Alert({Title: "提示", Content: "密码已修改成功，请重新登录",BtnL:"确定",FunL:alerts}) 	    	  		
	    	  // 	},3000)
